  ...
  #assignOpenEditModal() {
    Utility.assignFunction({
      ...
      functionToAssign: (element) => {
        ...
        editTaskModal.querySelector("#editDescriptionInput").value =
          taskData.description;
        editTaskModal.querySelector("#editPrioritySelect").value =
          taskData.priority;
        const editCategorySelect = editTaskModal.querySelector(
          "#editCategorySelect"
        );
        ...
        if (taskData.category !== "")
          editCategorySelect.value = taskData.category;
        editTaskModal.querySelector("#editDateSelect").value = format(
          taskData.dueDate,
          "yyyy-MM-dd"
        );
